...
> This TSDX setup is meant for developing libraries (not apps!) that can be published to NPM. If you’re looking to build
> a Node app, you could use `ts-node-dev`, plain `ts-node`, or simple `tsc`.
